...
@ %bb.2:                                @   in Loop: Header=BB1_26 Depth=1
	...
	cmp	r3, #26
	bhs	.LBB1_15
.LBB1_3:                                @   in Loop: Header=BB1_26 Depth=1
	ldrb	r4, [lr, #1]
	sub	r0, r4, #65
	cmp	r0, #26
	bhs	.LBB1_20
.LBB1_4:                                @   in Loop: Header=BB1_26 Depth=1
	...
	cmp	r4, #26
	blo	.LBB1_25
.LBB1_5:                                @   in Loop: Header=BB1_26 Depth=1
	sub	r4, r5, #97
	cmp	r4, #26
	bhs	.LBB1_9
@ %bb.6:                                @   in Loop: Header=BB1_26 Depth=1
	sub	r4, r5, #71
	b	.LBB1_25
...
@ %bb.8:                                @   in Loop: Header=BB1_26 Depth=1
	...
	blo	.LBB1_3
	b	.LBB1_15
.LBB1_9:                                @   in Loop: Header=BB1_26 Depth=1
	sub	r4, r5, #48
	cmp	r4, #10
	bhs	.LBB1_13
@ %bb.10:                               @   in Loop: Header=BB1_26 Depth=1
	add	r4, r5, #4
	b	.LBB1_25
.LBB1_11:                               @   in Loop: Header=BB1_26 Depth=1
	sub	r3, r0, #48
	cmp	r3, #9
	bhi	.LBB1_14
@ %bb.12:                               @   in Loop: Header=BB1_26 Depth=1
	add	r12, r0, #4
	ldrb	r0, [lr]
	sub	r3, r0, #65
	cmp	r3, #26
...
.LBB1_13:                               @   in Loop: Header=BB1_26 Depth=1
	...
	movweq	r4, #62
	b	.LBB1_25
.LBB1_14:                               @   in Loop: Header=BB1_26 Depth=1
	cmp	r0, #47
	mvn	r12, #0
	movweq	r12, #63
	cmp	r0, #43
	...
	cmp	r3, #26
	blo	.LBB1_3
.LBB1_15:                               @   in Loop: Header=BB1_26 Depth=1
	sub	r3, r0, #97
	cmp	r3, #26
	bhs	.LBB1_17
@ %bb.16:                               @   in Loop: Header=BB1_26 Depth=1
	sub	r3, r0, #71
	ldrb	r4, [lr, #1]
	sub	r0, r4, #65
	cmp	r0, #26
	blo	.LBB1_4
	b	.LBB1_20
.LBB1_17:                               @   in Loop: Header=BB1_26 Depth=1
	sub	r3, r0, #48
	cmp	r3, #10
	bhs	.LBB1_19
@ %bb.18:                               @   in Loop: Header=BB1_26 Depth=1
	add	r3, r0, #4
	ldrb	r4, [lr, #1]
	sub	r0, r4, #65
	cmp	r0, #26
...
.LBB1_19:                               @   in Loop: Header=BB1_26 Depth=1
	...
	cmp	r0, #26
	blo	.LBB1_4
.LBB1_20:                               @   in Loop: Header=BB1_26 Depth=1
	sub	r0, r4, #97
	cmp	r0, #26
	bhs	.LBB1_22
