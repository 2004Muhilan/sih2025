...
# %bb.0:
	...
	lw	$19, 320($sp)
	addiu	$20, $sp, 22
	lw	$25, %call16(rc4_init)($16)
	move	$4, $20
	.reloc ($tmp0), R_MIPS_JALR, rc4_init
$tmp0:
	jalr	$25
	move	$gp, $16
...
$tmp1:
	jalr	$25
	move	$gp, $16
	lw	$25, %call16(rc4_crypt)($16)
	move	$4, $20
	move	$5, $19
	move	$6, $17
	.reloc ($tmp2), R_MIPS_JALR, rc4_crypt
$tmp2:
	jalr	$25
	move	$gp, $16
...
# %bb.0:
	...
	lw	$25, %call16(rc4_init)($16)
	move	$4, $20
	.reloc ($tmp3), R_MIPS_JALR, rc4_init
$tmp3:
	jalr	$25
	move	$gp, $16
	lw	$25, %call16(memcpy)($16)
...
$tmp4:
	...
	move	$5, $19
	move	$6, $17
	.reloc ($tmp5), R_MIPS_JALR, rc4_crypt
$tmp5:
	jalr	$25
	move	$gp, $16
	lw	$16, 280($sp)                   # 4-byte Folded Reload
