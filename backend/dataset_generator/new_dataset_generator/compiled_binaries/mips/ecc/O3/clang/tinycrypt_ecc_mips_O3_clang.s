...
# %bb.0:
	...
	sw	$6, 44($sp)                     # 4-byte Folded Spill
	lbu	$23, 0($2)
...
$BB28_7:
	...
	sw	$7, 60($sp)                     # 4-byte Folded Spill
	move	$4, $18
	move	$5, $fp
	move	$6, $fp
...
# %bb.15:                               #   in Loop: Header=BB34_14 Depth=1
	...
	and	$1, $1, $22
	sw	$1, 0($23)
$BB34_16:                               #   Parent Loop BB34_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	lw	$1, 0($3)
	addiu	$3, $3, 4
	addiu	$4, $4, -1
...
# %bb.18:                               #   in Loop: Header=BB34_14 Depth=1
	addiu	$3, $zero, 0
	addiu	$2, $zero, 0
$BB34_19:                               #   Parent Loop BB34_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addu	$1, $16, $3
	addu	$4, $17, $3
	addu	$6, $18, $3
...
# %bb.20:                               #   in Loop: Header=BB34_14 Depth=1
	addiu	$4, $zero, 0
	addiu	$3, $zero, 0
$BB34_21:                               #   Parent Loop BB34_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addu	$1, $18, $4
	addiu	$4, $4, 4
	lw	$1, 0($1)
...
$BB34_24:
	addiu	$17, $zero, 64
$BB34_25:                               # =>This Inner Loop Header: Depth=1
	lw	$25, %lo(g_rng_function)($21)
	move	$4, $16
	jalr	$25
	move	$5, $19
